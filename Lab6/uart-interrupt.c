...
extern volatile char command_byte = 0x73; // byte value for special character used as a command
extern volatile int command_flag = 0; // flag to tell the main program a special command was received
